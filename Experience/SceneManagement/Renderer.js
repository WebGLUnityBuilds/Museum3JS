...
const createRenderer = (scene) => {
  ...
  let texture_lf = new THREE.TextureLoader().load('./Models/Environment/Skybox/arid2_rt.jpg');
  let texture_rt = new THREE.TextureLoader().load('./Models/Environment/Skybox/arid2_lf.jpg');
